...
export class PackageBuilderStateManagementService {
  ...
  // react to any change (logs all four slices)
  constructor() {
    effect(() => {
      console.log('Makkah Hotel:', this.makkahHotelState());
      console.log('Madina Hotel:', this.madinaHotelState());
      console.log('Transport:', this.transportState());
      console.log('Food:', this.foodState());
      console.log('Tickets:', this.ticketState());
      console.log('Final Detials:', this.finalDetailsState());
    });
  }
